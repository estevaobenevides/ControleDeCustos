...
{
    public partial class CreateControleDeCustoTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FuncionarioDepartamentos", x => new { x.FuncionarioId, x.DepartamentoId });
                    table.ForeignKey(
                        name: "FK_FuncionarioDepartamentos_Departamentos_DepartamentoId",
                        column: x => x.DepartamentoId,
                        principalTable: "Departamentos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FuncionarioDepartamentos_Funcionarios_FuncionarioId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FuncionarioDepartamentos_DepartamentoId",
